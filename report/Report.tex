...
Even though inspection was not exhaustive, we can note a couple of interesting observations: meantime faces with a Low level of occlusion look
normal, faces with Medium level occlusion will be impacted by hair, hands/arms or a hat. Finally the images with a High level of occlusion
are not necessarily covered but kind of blurry. If we assume these factors as representative of the whole dataset (train + test)
this learning could be useful if doing data augmentation.
